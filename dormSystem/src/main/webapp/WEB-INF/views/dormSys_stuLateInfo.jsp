  ...
  <head>
	...
	<script type="text/javascript">
		...
		function findByDate() {
			...
			$.ajax({
				 type:"post",
				 url:"${pageContext.request.contextPath}/selectByBanIdAndDate",
         ...
         <div class="right_cont">
              <ul class="breadcrumb">
                ...
                <span>楼栋管理员</span> <span class="divider">/</span>
               	<b>晚归管理</b><span class="divider"></span>	 
              </ul>
             <div class="title_right"><strong>学生晚归记录信息</strong></div>
             ...
             <div id="content" class="container-fluid" style="height:350px;">
       	     ...
       	     <div id="page" align="center">
			 		<nav aria-label="Page navigation" align="center">
					  <ul class="pagination">
					         <!-- 首页 -->
			                <li><a href="${pageContext.request.contextPath}/dormSys_stuLateInfo?pn=1">首页</a></li>
			                <!--上一页-->
			                <li>
			                    <c:if test="${pageinfo.hasPreviousPage}">
			                        <a href="${pageContext.request.contextPath}/dormSys_stuLateInfo?pn=${pageinfo.pageNum-1}" aria-label="Previous">
			                ...
			                <c:forEach items="${pageinfo.navigatepageNums}" var="page_num">
			                    <c:if test="${page_num == pageinfo.pageNum}">
			                         <li class="active"><a href="${pageContext.request.contextPath}/dormSys_stuLateInfo?pn=${page_num}">${page_num}</a></li>
			                    </c:if>
			                    <c:if test="${page_num != pageinfo.pageNum}">
			                        <li><a href="${pageContext.request.contextPath}/dormSys_stuLateInfo?pn=${page_num}">${page_num}</a></li>
			                    </c:if>
			                </c:forEach>
			                <!--下一页-->
			                <li>
			                    <c:if test="${pageinfo.hasNextPage}">
			                        <a href="${pageContext.request.contextPath}/dormSys_stuLateInfo?pn=${pageinfo.pageNum+1}" aria-label="Next">
			                          <span aria-hidden="true">»</span>
			                        </a>
			                    </c:if>
			                </li>
			                <!-- 尾页 -->
			                <li><a href="${pageContext.request.contextPath}/dormSys_stuLateInfo?pn=${pageinfo.pages}">尾页</a></li>
					  </ul>
					</nav>
					<div align="center">
