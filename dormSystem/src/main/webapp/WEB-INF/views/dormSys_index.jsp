    ...
    <div class="right"  id="mainFrame">
         <div class="right_cont">
             ...
             <div id="content" class="container-fluid">
             	<div class="col-md-12">
             		<div id="index">
	             		<h1 align="center" style="font-family:'宋体'">欢迎您,
	             			<span style="color:red"><%=session.getAttribute("dormSysName")%></span>	楼栋管理员
	             		      
	             		</h1>
	             		<h2 align="center">管理楼栋: &nbsp;<span style="color:red"><%=session.getAttribute("banId") %></span> 栋</h2>
             		</div>
             	</div>
			 </div>
        </div>
