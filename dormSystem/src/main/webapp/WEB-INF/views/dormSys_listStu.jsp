  ...
  <head>
	...
	<script type="text/javascript">
		...
		function selectOneByParam() {
			...
			var stuBanId = ${banId};
			$.ajax({
				url:'${pageContext.request.contextPath}/selectOneByParamAndBan',
                    type:'post',
                    data:{"param":param,"stuBanId":stuBanId},
                    dataType:"json",
				    success:function(data) {
                    	...
                    	var tr = "<tr><td>"+data.stuId+"</td><td>"+data.stuName+"</td><td>" +data.stuSex+"</td><td>"
                    	 			...
                    	 			+ stuBanId + "</td><td>" +data.stuDormId +"</td><td>" + data.stuInState + "</td><td>"
                    	 			+ operation+ "</td></tr>";
                    	 $("#tabInfo").append(tr);
				    },
				    error:function() {
             ...
             <div id="content" class="container-fluid" style="height:350px;">
       	     ...
       	     <div id="page" align="center">
			 		<nav aria-label="Page navigation" align="center">
					  <ul class="pagination">
					         <!-- 首页 -->
			                <li><a href="${pageContext.request.contextPath}/dormSys_stuInfo?pn=1">首页</a></li>
			                <!--上一页-->
			                <li>
			                    <c:if test="${pageinfo.hasPreviousPage}">
			                        <a href="${pageContext.request.contextPath}/dormSys_stuInfo?pn=${pageinfo.pageNum-1}" aria-label="Previous">
			                ...
			                <c:forEach items="${pageinfo.navigatepageNums}" var="page_num">
			                    <c:if test="${page_num == pageinfo.pageNum}">
			                         <li class="active"><a href="${pageContext.request.contextPath}/dormSys_stuInfo?pn=${page_num}">${page_num}</a></li>
			                    </c:if>
			                    <c:if test="${page_num != pageinfo.pageNum}">
			                        <li><a href="${pageContext.request.contextPath}/dormSys_stuInfo?pn=${page_num}">${page_num}</a></li>
			                    </c:if>
			                </c:forEach>
			                <!--下一页-->
			                <li>
			                    <c:if test="${pageinfo.hasNextPage}">
			                        <a href="${pageContext.request.contextPath}/dormSys_stuInfo?pn=${pageinfo.pageNum+1}" aria-label="Next">
			                          <span aria-hidden="true">»</span>
			                        </a>
			                    </c:if>
			                </li>
			                <!-- 尾页 -->
			                <li><a href="${pageContext.request.contextPath}/dormSys_stuInfo?pn=${pageinfo.pages}">尾页</a></li>
					  </ul>
					</nav>
					<div align="center">
